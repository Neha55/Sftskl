  ...
  <div class="container">
    ...
    <section id="content">
        ...
        <h2>EDIT <span>YOUR <span>PROFILE</span></span></h2>
         ...
         <nav>
        <p class="p0"><li class="current"><a href="edit_view1.php" class="m1">View Profile</a></li></p>
        <p class="p0"><li class="current"><a href="edit_pwd1.php" class="m1">Change Password</a></li></p>
        </n
      ></div>
    </section>
  </div>
