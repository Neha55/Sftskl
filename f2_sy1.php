...
<?php
		...
		//echo $d;
		echo "<br>";
 		mysql_select_db("timetable_sy", $con);
		$q5="SELECT course_incharge FROM tt_sy where day='$day'";
		$result5=mysql_query($q5);
		$r5=mysql_fetch_array($result5); 
		
		//for student name
		mysql_select_db("sy", $con);
		$q2="SELECT Name FROM sy_class where Rollno='$r1'";
...
<div id="wrapper">
	...
	<form name="Activity updates " class="login-form" action="update_activity_sy1.php" method="post" onsubmit='return check_time()'>
		...
		Time<input name="time" type="text" id="time" class="input t_name" placeholder="Time" value="10:15 AM" title="enter time" style="margin-left:76px;" readonly/>
