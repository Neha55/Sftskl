...
<?php
		...
		//echo $d;
		echo "<br>";
 		mysql_select_db("timetable_btech", $con);
		$q5="SELECT course_incharge FROM tt_btech where day='$day'";
		$result5=mysql_query($q5);
		$r5=mysql_fetch_array($result5); 
		
		//for student name
		mysql_select_db("btech", $con);
		$q2="SELECT Name FROM btech_class where Rollno='$r1'";
...
<div id="wrapper">
	...
	<form name="Activity updates " class="login-form" action="update_activity_btech1.php" method="post" onsubmit='return check_time()'>
