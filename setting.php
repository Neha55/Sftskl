  ...
  <div class="container">
    ...
    <section id="content">
        ...
        <h2>USER SETTINGS</h2>
         ...
         <nav>
        <p class="p0"><li class="current"><a href="add_user.php" class="m1">Add User</a></li></p>
        <p class="p0"><li class="current"><a href="del_user.php" class="m1">Delete User</a></li></p>
        <p class="p0"><li class="current"><a href="view_user.php" class="m1">View Profiles</a></li></p>
        </n
      ></div>
    </section>
  </div>
